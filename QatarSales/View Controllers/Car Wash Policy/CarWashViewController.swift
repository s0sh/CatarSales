...
extension CarWashViewController : UITableViewDelegate {
...
extension CarWashViewController : UITableViewDataSource {
...
extension CarWashViewController : BottomViewWithTwoFilterOptionsDelegate {
    ...
    func bottomViewWithTwoFilterOptionsDidSelect(_ bottomView : BottomViewWithTwoFilterOptions, atIndex index : Int) {
        ...
        case 0:
            ...
            showActionSheet(values: ["Any", "Shop", "Home Service"], CompletionHandler: {(selectedValue : String?) in
