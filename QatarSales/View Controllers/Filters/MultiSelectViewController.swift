...
//    var dataSource : [String] = ["option1", "option2", "option3", "option4", "option5", "option6"]
    var dataSource : [String] = []
    var selectedValues : [String] = []
    @IBOutlet weak var lblTitle: UILabel!
    var titielLabel : String = "Sort"
...
extension MultiSelectViewController : UITableViewDelegate {
...
extension MultiSelectViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell : UITableViewCell? = tableView.dequeueReusableCell(withIdentifier: "identifierMutiSelect")
        
        if (cell == nil) {
            
            cell = UITableViewCell(style: .default, reuseIdentifier: "identifierMutiSelect")
        }
