//
//  FilterFiveViewController.swift
//  QatarSales
//
...
class FilterFiveViewController: UIViewController {

    @IBOutlet weak var tableview: UITableView!
    var dataSource : [String] = ["Any", "Shop", "Home Service"]
...
extension FilterFiveViewController : UITableViewDelegate {
...
extension FilterFiveViewController : UITableViewDataSource {
