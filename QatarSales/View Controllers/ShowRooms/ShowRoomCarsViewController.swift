//
//  ShowRoomCarsViewController.swift
//  QatarSales
//
...
class ShowRoomCarsViewController: UIViewController {
    ...
    func navigateTo(ViewController identifier : String) {
        ...
        let viewController : ShowRoomDetailViewController = Utilities.Storyboard.getControllerFrom(Stroyboard: Constants.Storyboards.mainStoryboard, WithIdentifier: identifier) as! ShowRoomDetailViewController
        self.navigationController?.pushViewController(viewController, animated: true)
    }
}

extension ShowRoomCarsViewController : UICollectionViewDelegate {
...
extension ShowRoomCarsViewController : UICollectionViewDataSource {
...
extension ShowRoomCarsViewController : UICollectionViewDelegateFlowLayout {
